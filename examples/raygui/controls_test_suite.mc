...
// GUI controls state (hoisted to module scope so UpdateDrawFrame can see it).
private {
...
i32 main() {
    ...
    // GUI controls initialization (runtime-produced values assigned here)
    colorPickerValue = RED;
    listViewExList[0] = "This";
    listViewExList[1] = "is";
    listViewExList[2] = "a";
    listViewExList[3] = "list view";
    listViewExList[4] = "with";
    listViewExList[5] = "disable";
    listViewExList[6] = "elements";
    listViewExList[7] = "amazing!";
