// gl_core33.mc - canonical, cross-platform GL 3.3-core binding.
//
//   windows - opengl32 exports only GL 1.1; everything is fetched at
//             runtime (GetProcAddress -> wglGetProcAddress) into fn
//             pointers; gl_load_all_fns() loads them.
//   linux   - libGL.so.1 exports the entry points -> direct extern;
//             gl_load_all_fns() is a no-op.
//   macos   - OpenGL.framework likewise (framework target unverified;
//             macOS GL is capped at 4.1).
// Call gl_load_all_fns() once after the GL context is current.

// --- constants (Khronos registry values; universal) ---------
...
const u32 GL_LUMINANCE_ALPHA = 0x190A;
const u32 GL_RED_EXT = 0x1903;
const u32 GL_R32F_EXT = 0x822E;
const u32 GL_RGB32F_EXT = 0x8815;
const u32 GL_R16F_EXT = 0x822D;
const u32 GL_RGB16F_EXT = 0x881B;
const u32 GL_RGBA16F_EXT = 0x881A;
const u32 GL_RGBA32F_EXT = 0x8814;
const u32 GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS = 0x8CD9;
...
when os(windows) {
    ...
    // Load every entry point: try the opengl32 static export
    // (GL 1.1), then the WGL driver-extension route (GL 2.0+).
    ...
    // Entry points are linked directly; nothing to load.
    ...
    extern "gl" void glActiveTexture(u32 texture);
    extern "gl" void glAttachShader(u32 program, u32 shader);
    extern "gl" void glBindAttribLocation(u32 program, u32 index, u8* name);
    extern "gl" void glBindBuffer(u32 target, u32 buffer);
    extern "gl" void glBindFramebuffer(u32 target, u32 framebuffer);
    extern "gl" void glBindRenderbuffer(u32 target, u32 renderbuffer);
    extern "gl" void glBindTexture(u32 target, u32 texture);
    extern "gl" void glBindVertexArray(u32 array);
    extern "gl" void glBlendColor(f32 r, f32 g, f32 b, f32 a);
    extern "gl" void glBlendEquation(u32 mode);
    extern "gl" void glBlendEquationSeparate(u32 modeRGB, u32 modeAlpha);
    extern "gl" void glBlendFunc(u32 sfactor, u32 dfactor);
    extern "gl" void glBlendFuncSeparate(u32 srcRGB, u32 dstRGB, u32 srcAlpha, u32 dstAlpha);
    extern "gl" void glBlitFramebuffer(i32 srcX0, i32 srcY0, i32 srcX1, i32 srcY1, i32 dstX0, i32 dstY0, i32 dstX1, i32 dstY1, u32 mask, u32 filter);
    extern "gl" void glBufferData(u32 target, i64 size, void* data, u32 usage);
    extern "gl" void glBufferSubData(u32 target, i64 offset, i64 size, void* data);
    extern "gl" u32 glCheckFramebufferStatus(u32 target);
    extern "gl" void glClear(u32 mask);
    extern "gl" void glClearBufferfi(u32 buffer, i32 drawbuffer, f32 depth, i32 stencil);
    extern "gl" void glClearBufferfv(u32 buffer, i32 drawbuffer, f32* value);
    extern "gl" void glClearBufferuiv(u32 buffer, i32 drawbuffer, u32* value);
    extern "gl" void glClearColor(f32 r, f32 g, f32 b, f32 a);
    extern "gl" void glClearDepth(f64 depth);
    extern "gl" void glClearStencil(i32 s);
    extern "gl" void glColorMask(u8 r, u8 g, u8 b, u8 a);
    extern "gl" void glCompileShader(u32 shader);
    extern "gl" void glCompressedTexImage2D(u32 target, i32 level, u32 internalformat, i32 width, i32 height, i32 border, i32 imageSize, void* data);
    extern "gl" void glCompressedTexImage3D(u32 target, i32 level, u32 internalformat, i32 width, i32 height, i32 depth, i32 border, i32 imageSize, void* data);
    extern "gl" u32 glCreateProgram();
    extern "gl" u32 glCreateShader(u32 type);
    extern "gl" void glCullFace(u32 mode);
    extern "gl" void glDeleteBuffers(i32 n, u32* buffers);
    extern "gl" void glDeleteFramebuffers(i32 n, u32* framebuffers);
    extern "gl" void glDeleteProgram(u32 program);
    extern "gl" void glDeleteRenderbuffers(i32 n, u32* renderbuffers);
    extern "gl" void glDeleteShader(u32 shader);
    extern "gl" void glDeleteTextures(i32 n, u32* textures);
    extern "gl" void glDeleteVertexArrays(i32 n, u32* arrays);
    extern "gl" void glDepthFunc(u32 func);
    extern "gl" void glDepthMask(u8 flag);
    extern "gl" void glDetachShader(u32 program, u32 shader);
    extern "gl" void glDisable(u32 cap);
    extern "gl" void glDisableVertexAttribArray(u32 index);
    extern "gl" void glDrawArrays(u32 mode, i32 first, i32 count);
    extern "gl" void glDrawArraysInstanced(u32 mode, i32 first, i32 count, i32 instancecount);
    extern "gl" void glDrawBuffers(i32 n, u32* bufs);
    extern "gl" void glDrawElements(u32 mode, i32 count, u32 type, void* indices);
    extern "gl" void glDrawElementsInstanced(u32 mode, i32 count, u32 type, void* indices, i32 instancecount);
    extern "gl" void glEnable(u32 cap);
    extern "gl" void glEnableVertexAttribArray(u32 index);
    extern "gl" void glFramebufferRenderbuffer(u32 target, u32 attachment, u32 renderbuffertarget, u32 renderbuffer);
    extern "gl" void glFramebufferTexture2D(u32 target, u32 attachment, u32 textarget, u32 texture, i32 level);
    extern "gl" void glFramebufferTextureLayer(u32 target, u32 attachment, u32 texture, i32 level, i32 layer);
    extern "gl" void glFrontFace(u32 mode);
    extern "gl" void glGenBuffers(i32 n, u32* buffers);
    extern "gl" void glGenFramebuffers(i32 n, u32* framebuffers);
    extern "gl" void glGenRenderbuffers(i32 n, u32* renderbuffers);
    extern "gl" void glGenTextures(i32 n, u32* textures);
    extern "gl" void glGenVertexArrays(i32 n, u32* arrays);
    extern "gl" void glGenerateMipmap(u32 target);
    extern "gl" i32 glGetAttribLocation(u32 program, u8* name);
    extern "gl" u32 glGetError();
    extern "gl" void glGetFloatv(u32 pname, f32* params);
    extern "gl" void glGetFramebufferAttachmentParameteriv(u32 target, u32 attachment, u32 pname, i32* params);
    extern "gl" void glGetIntegerv(u32 pname, i32* params);
    extern "gl" void glGetProgramInfoLog(u32 program, i32 bufSize, i32* length, u8* infoLog);
    extern "gl" void glGetProgramiv(u32 program, u32 pname, i32* params);
    extern "gl" void glGetShaderInfoLog(u32 shader, i32 bufSize, i32* length, u8* infoLog);
    extern "gl" void glGetShaderiv(u32 shader, u32 pname, i32* params);
    extern "gl" u8* glGetString(u32 name);
    extern "gl" u8* glGetStringi(u32 name, u32 index);
    extern "gl" void glGetTexImage(u32 target, i32 level, u32 format, u32 type, void* pixels);
    extern "gl" i32 glGetUniformLocation(u32 program, u8* name);
    extern "gl" void glLineWidth(f32 width);
    extern "gl" void glLinkProgram(u32 program);
    extern "gl" void glPixelStorei(u32 pname, i32 param);
    extern "gl" void glPolygonMode(u32 face, u32 mode);
    extern "gl" void glPolygonOffset(f32 factor, f32 units);
    extern "gl" void glReadBuffer(u32 mode);
    extern "gl" void glReadPixels(i32 x, i32 y, i32 width, i32 height, u32 format, u32 type, void* data);
    extern "gl" void glRenderbufferStorage(u32 target, u32 internalformat, i32 width, i32 height);
    extern "gl" void glRenderbufferStorageMultisample(u32 target, i32 samples, u32 internalformat, i32 width, i32 height);
    extern "gl" void glScissor(i32 x, i32 y, i32 width, i32 height);
    extern "gl" void glShaderSource(u32 shader, i32 count, u8** string, i32* length);
    extern "gl" void glStencilFunc(u32 func, i32 ref, u32 mask);
    extern "gl" void glStencilFuncSeparate(u32 face, u32 func, i32 ref, u32 mask);
    extern "gl" void glStencilMask(u32 mask);
    extern "gl" void glStencilOp(u32 sfail, u32 dpfail, u32 dppass);
    extern "gl" void glStencilOpSeparate(u32 face, u32 sfail, u32 dpfail, u32 dppass);
    extern "gl" void glTexImage2D(u32 target, i32 level, i32 internalformat, i32 width, i32 height, i32 border, u32 format, u32 type, void* pixels);
    extern "gl" void glTexImage3D(u32 target, i32 level, i32 internalformat, i32 width, i32 height, i32 depth, i32 border, u32 format, u32 type, void* pixels);
    extern "gl" void glTexParameterf(u32 target, u32 pname, f32 param);
    extern "gl" void glTexParameterfv(u32 target, u32 pname, f32* params);
    extern "gl" void glTexParameteri(u32 target, u32 pname, i32 param);
    extern "gl" void glTexParameteriv(u32 target, u32 pname, i32* params);
    extern "gl" void glTexSubImage2D(u32 target, i32 level, i32 xoffset, i32 yoffset, i32 width, i32 height, u32 format, u32 type, void* pixels);
    extern "gl" void glTexSubImage3D(u32 target, i32 level, i32 xoffset, i32 yoffset, i32 zoffset, i32 width, i32 height, i32 depth, u32 format, u32 type, void* pixels);
    extern "gl" void glUniform1fv(i32 location, i32 count, f32* value);
    extern "gl" void glUniform1i(i32 location, i32 v0);
    extern "gl" void glUniform1iv(i32 location, i32 count, i32* value);
    extern "gl" void glUniform1uiv(i32 location, i32 count, u32* value);
    extern "gl" void glUniform2fv(i32 location, i32 count, f32* value);
    extern "gl" void glUniform2iv(i32 location, i32 count, i32* value);
    extern "gl" void glUniform2uiv(i32 location, i32 count, u32* value);
    extern "gl" void glUniform3fv(i32 location, i32 count, f32* value);
    extern "gl" void glUniform3iv(i32 location, i32 count, i32* value);
    extern "gl" void glUniform3uiv(i32 location, i32 count, u32* value);
    extern "gl" void glUniform4f(i32 location, f32 v0, f32 v1, f32 v2, f32 v3);
    extern "gl" void glUniform4fv(i32 location, i32 count, f32* value);
    extern "gl" void glUniform4iv(i32 location, i32 count, i32* value);
    extern "gl" void glUniform4uiv(i32 location, i32 count, u32* value);
    extern "gl" void glUniformMatrix4fv(i32 location, i32 count, u8 transpose, f32* value);
    extern "gl" void glUseProgram(u32 program);
    extern "gl" void glVertexAttrib1fv(u32 index, f32* v);
    extern "gl" void glVertexAttrib2fv(u32 index, f32* v);
    extern "gl" void glVertexAttrib3fv(u32 index, f32* v);
    extern "gl" void glVertexAttrib4fv(u32 index, f32* v);
    extern "gl" void glVertexAttribDivisor(u32 index, u32 divisor);
    extern "gl" void glVertexAttribPointer(u32 index, i32 size, u32 type, u8 normalized, i32 stride, void* pointer);
    extern "gl" void glViewport(i32 x, i32 y, i32 width, i32 height);
    extern "gl" void glClearDepthf(f32 d);
    // WebGL imports are always resolved; nothing to load.
    bool gl_load_all_fns() { return true; }
}
