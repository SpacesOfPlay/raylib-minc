...
// GENERATED by scripts/gen_gl_binding.py - do not edit by hand;
// edit the function table there and regenerate.
//
// One binding for every GL consumer (sokol, raylib/rlgl, ...). GL is
// a Khronos-registry surface; types are raw minc, constants universal.
// Per-OS function loading (DESIGN.md s8.x):
